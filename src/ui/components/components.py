...
class Components():
    ...
    def draw(self, states, dimensions, selected_model):
        ...
        if states["right_window/components_header"]:
            ...
            imgui.text("Shader")
            clicked, selected_shader = imgui.combo("###combo_shader", shaders.index(rm.models[selected_model].shader), shaders)
            ...
            imgui.text("Material")
            clicked, selected_material = imgui.combo("###combo_material", materials.index(rm.models[selected_model].material), materials)
            ...
            imgui.text("Texture")
            clicked, selected_texture = imgui.combo("###combo_texture", textures.index(rm.models[selected_model].texture), textures)
